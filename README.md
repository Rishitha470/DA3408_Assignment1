`Q1` folder contains the `Q1_Answer.txt` and a `README` file.

`Q2` folder contains the `.py` file and a `README` file.

`Q3` folder contains the screenshots, the files related to the question and a `README` file which explains everything.
